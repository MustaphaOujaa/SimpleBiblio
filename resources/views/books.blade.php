                ...
                <div class="col-span-1 lg:col-span-3">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-lg p-4 flex items-center justify-between border border-gray-200 shadow-sm hover:shadow-lg transition">
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=80&h=110&fit=crop" alt="Book Cover" class="w-20 h-auto object-cover rounded-md mr-4">
                                <div>
                        ...
                        <div class="bg-white rounded-lg p-4 flex items-center justify-between border border-gray-200 shadow-sm hover:shadow-lg transition">
                            <div class="flex items-center">
                                <img src="https://images.unsplash.com/photo-1512820790803-83ca734da794?w=80&h=110&fit=crop" alt="Book Cover" class="w-20 h-auto object-cover rounded-md mr-4">
                                <div>
